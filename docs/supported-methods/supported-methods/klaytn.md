...
Klaytn is known for its high performance and stability, making it a popular choice for various blockchain applications.

- [Klaytn Developer Documentation](https://docs.klaytn.com)
- [Klaytn Community Forum](https://forum.klaytn.com)
- [Klaytn Github Repository](https://github.com/klaytn)

---

## Klaytn on Grove

Grove supports Klaytn, providing developers with the tools to build on this innovative platform. We enable seamless interaction with Klaytn's network through our robust infrastructure.

---

## Supported Chain Variants

Grove supports the mainnet of Klaytn:

### Klaytn Mainnet

`klaytn-mainnet`

The primary network for Klaytn, suitable for all standard operations.
...
The following methods are supported on the Klaytn Mainnet:
...
## Getting Started with Klaytn on Grove

To begin using Klaytn functionalities via Grove, follow these steps:

### 1. Set Up an Account on Grove

Create an account on Grove by [signing up here](#). [Instructions for account setup and management].

### 2. Copy your Klaytn endpoint URL

Find and copy the endpoint URL specific to Klaytn Mainnet on Grove.
...
A basic JavaScript example to get started with Klaytn Mainnet:

```javascript
// Example: Interacting with Klaytn Mainnet
const klaytn_endpoint = "<Grove_Klaytn_API_Endpoint>";
const apiKey = "<Your_API_Key>";
// Insert your Klaytn interaction code here
