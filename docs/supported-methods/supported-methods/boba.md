...
| `rollup_getInfo` | Returns useful L2-specific information about the current node |
| `rollup_gasPrices` | Returns the L1 and L2 gas prices that are being used by the Sequencer to calculate fees |
