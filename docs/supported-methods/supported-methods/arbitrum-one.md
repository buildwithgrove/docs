...
Supported methods for Arbitrum allow developers to interact with the Arbitrum blockchain in various ways. These methods include functionalities such as getting account balances, estimating gas costs, executing transactions, querying block and transaction data, and more. For a deeper understanding of the specific methods for the Arbitrum chain, refer to their official documentation [here](https://developer.arbitrum.io/).
