...
- **Mainnet**
  ...
  - example: [eth-mainnet](/ethereum-api/endpoints/eth-mainnet)
- **Archival**
  - The node configuration with access to the full historical blockchain data.
  - example: [eth-archival](/ethereum-api/endpoints/eth-archival)
- **Trace**
  - A node configuration that supports a subset of client-agnostic trace and debug methods.
  - example: [eth-trace](/ethereum-api/endpoints/eth-trace)
- **Custom**
